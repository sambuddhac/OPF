/* Produced by CVXGEN, 2015-09-15 18:00:17 -0400.  */
...
/*array<double, 1> Gensolver::getThetaSol(void) {
for ( int i = 0; i < 1; ++i ) {
...
double Gensolver::eval_objv(void) {
  ...
  objv += params.c0[0]+work.frac_121674190848*(work.quad_890299719680[0]+work.quad_311138062336[0]);
  return objv;
}
...
void Gensolver::multbyP(double *lhs, double *rhs) {
  ...
  lhs[0] = rhs[0]*(2*(params.c2[0]+work.frac_121674190848*work.quad_786759720960[0]));
  lhs[1] = rhs[1]*(2*work.frac_121674190848);
}
void Gensolver::fillq(void) {
  work.q[0] = params.c1[0]+2*work.frac_121674190848*(-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0])*params.ones[0];
...
void Gensolver::pre_ops(void) {
  ...
  work.quad_786759720960[0] = params.ones[0]*params.ones[0];
  work.quad_890299719680[0] = (-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0])*(-params.Pg_N_init[0]+params.Pg_N_avg[0]+params.ug_N[0]);
  work.quad_311138062336[0] = (-params.Vg_N_avg[0]-params.Thetag_N_avg[0]+params.vg_N[0])*(-params.Vg_N_avg[0]-params.Thetag_N_avg[0]+params.vg_N[0]);
}
/* Produced by CVXGEN, 2015-09-15 18:00:17 -0400.  */
/* CVXGEN is Copyright (C) 2006-2012 Jacob Mattingley, jem@cvxgen.com. */
/* The code in this file is Copyright (C) 2006-2012 Jacob Mattingley. */
...
void Gensolver::fill_KKT(void) {
  work.KKT[7] = 2*(params.c2[0]+work.frac_121674190848*work.quad_786759720960[0]);
